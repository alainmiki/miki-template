...
- [Register a Simple Tag param($m) if ($m.Groups[1].Value -notmatch '\.md
- [Async Custom Tags param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#async-custom-tags.md' 
- [Parsing Complex Tags param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#parsing-complex-tags.md' 
- [Accessing the Parser param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#accessing-the-parser.md' 
- [Tag Registration Best Practices param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#tag-registration-best-practices.md' 
...
- [Built-in Tags Reference param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '../api/tags.md.md' 
- [Custom Filters param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', 'custom-filters.md.md' 
- [Guide: Tags param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', 'tags.md.md' 
...
- [Parsing Complex Tags param($m) if ($m.Groups[1].Value -notmatch '\.md
- [Accessing the Parser param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#accessing-the-parser.md' 
- [Tag Registration Best Practices param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#tag-registration-best-practices.md' 
...
- [Accessing the Parser param($m) if ($m.Groups[1].Value -notmatch '\.md
- [Tag Registration Best Practices param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#tag-registration-best-practices.md' 
...
- [Tag Registration Best Practices param($m) if ($m.Groups[1].Value -notmatch '\.md
