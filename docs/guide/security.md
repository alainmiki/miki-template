...
- [Auto-Escaping param($m) if ($m.Groups[1].Value -notmatch '\.md
- [SafeString param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#safestring.md' 
- [CSRF Protection param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#csrf-protection.md' 
- [CSP Nonce param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#csp-nonce.md' 
- [Path Traversal Protection param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#path-traversal-protection.md' 
- [No Unsafe Code Execution param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#no-unsafe-code-execution.md' 
- [HTML Escaping Details param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#html-escaping-details.md' 
- [Context Processor Security param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#context-processor-security.md' 
...
miki-template uses the [`he` param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', 'https://github.com/mathiasbynetworks/he.md'  library for HTML escaping, which converts:
...
- [Integrations param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '../integrations/.md.md' 
- [API Reference: Security param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '../api/security.md.md' 
) { $m.Groups[1].Value + '.md' + '#' + $m.Groups[2].Value } else { $m.Value } 
- [SafeString param($m) if ($m.Groups[1].Value -notmatch '\.md
- [CSRF Protection param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#csrf-protection.md' 
- [CSP Nonce param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#csp-nonce.md' 
- [Path Traversal Protection param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#path-traversal-protection.md' 
- [No Unsafe Code Execution param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#no-unsafe-code-execution.md' 
...
- [CSRF Protection param($m) if ($m.Groups[1].Value -notmatch '\.md
- [CSP Nonce param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#csp-nonce.md' 
- [Path Traversal Protection param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#path-traversal-protection.md' 
- [No Unsafe Code Execution param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#no-unsafe-code-execution.md' 
- [HTML Escaping Details param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#html-escaping-details.md' 
...
- [CSP Nonce param($m) if ($m.Groups[1].Value -notmatch '\.md
- [Path Traversal Protection param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#path-traversal-protection.md' 
- [No Unsafe Code Execution param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#no-unsafe-code-execution.md' 
- [HTML Escaping Details param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#html-escaping-details.md' 
- [Context Processor Security param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#context-processor-security.md' 
...
- [No Unsafe Code Execution param($m) if ($m.Groups[1].Value -notmatch '\.md
- [HTML Escaping Details param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#html-escaping-details.md' 
- [Context Processor Security param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#context-processor-security.md' 
...
- [HTML Escaping Details param($m) if ($m.Groups[1].Value -notmatch '\.md
- [Context Processor Security param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#context-processor-security.md' 
...
- [Context Processor Security param($m) if ($m.Groups[1].Value -notmatch '\.md
