...
- [Caching param($m) if ($m.Groups[1].Value -notmatch '\.md
- [Library System param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#library-system.md' 
- [i18n / Internationalization param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#i18n--internationalization.md' 
- [Template Discovery param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#template-discovery.md' 
- [Partial Templates param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#partial-templates.md' 
- [Extending the Engine param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#extending-the-engine.md' 
...
- [API Reference: Libraries param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '../api/libraries.md.md' 
- [API Reference: Cache param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '../api/cache.md.md' 
- [API Reference: i18n param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '../api/i18n.md.md' 
) { $m.Groups[1].Value + '.md' + '#' + $m.Groups[2].Value } else { $m.Value } 
- [Library System param($m) if ($m.Groups[1].Value -notmatch '\.md
- [i18n / Internationalization param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#i18n--internationalization.md' 
- [Template Discovery param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#template-discovery.md' 
- [Partial Templates param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#partial-templates.md' 
- [Extending the Engine param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#extending-the-engine.md' 
...
- [i18n / Internationalization param($m) if ($m.Groups[1].Value -notmatch '\.md
- [Template Discovery param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#template-discovery.md' 
- [Partial Templates param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#partial-templates.md' 
- [Extending the Engine param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#extending-the-engine.md' 
...
- [Template Discovery param($m) if ($m.Groups[1].Value -notmatch '\.md
- [Partial Templates param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#partial-templates.md' 
- [Extending the Engine param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#extending-the-engine.md' 
...
- [Partial Templates param($m) if ($m.Groups[1].Value -notmatch '\.md
- [Extending the Engine param($m) $m.Value -replace '([a-z][a-z0-9/-]*)(?<!\.md)', '#extending-the-engine.md' 
...
- [Extending the Engine param($m) if ($m.Groups[1].Value -notmatch '\.md
